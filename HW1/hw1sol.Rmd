...
**Solution** Let's display the first 10 lines of `ADMISSIONS.csv`. There are 58977 rows in this data file. There are 47106 unique patients.
    ```{bash}
    head /home/203bdata/mimic-iii/ADMISSIONS.csv
    wc -l /home/203bdata/mimic-iii/ADMISSIONS.csv
    awk -F, '{ print $2 }' /home/203bdata/mimic-iii/ADMISSIONS.csv | uniq | tail -n+2 | wc -l
    awk -F, '{ print $10, $11, $12, $13, $14 }' /home/203bdata/mimic-iii/ADMISSIONS.csv | head
    ```

...
admission %>%
  ...
  labs(x = "Admission Year",
       ...
       subtitle = "There was no outbreak of admissions over years.")
```
...
admission %>% 
  ...
  labs(x = "Marital Status",
       ...
       subtitle = "Many patients were married.") +
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank())
```
...
Next, I will summerize some variables based on unique patients using appropriate graphs.
...
aP %>% 
  ...
  labs(y = "Gender",
       ...
       subtitle = "There were more males than females, but their proportion
...
aP %>% 
  ...
  labs(x = "Age at Admission",
       ...
       subtitle = "Age 0 (newborns) was a peak of the admissions.
...
ICU %>% 
  ...
  labs(x = "First ICU Unit Care",
       ...
       subtitle = "There was a big proportion of patients having MICU as 

...
admission %>%
  ...
  labs(x = "Admission Month",
       ...
       caption = "We see the number of hospital admissions are 
...
admission %>% 
  ...
  labs(x = "Admission weekday",
       ...
       caption = "Weekdays are busier than weekends")
```
...
admission %>% 
  ...
  labs(x = "Admission hour",
       ...
       caption = "The peak hour of admissions is 7 a.m. in the morning. 
...
admission %>% 
  ...
  labs(x = "Length of hospital stay (days)",
       ...
       caption = "The majority of patients stayed in the hospital less than 50 days.")
```
...
admission %>% 
  ...
  labs(x = "Number of admissions per patient",
       ...
       caption = "Most patients have only admitted to the hospital once.")
```
...
admission %>% 
  ...
  labs(title = "Number of Deaths vs. Survivals",
       caption = "The majority of patients survived after their admissions 
       to the hospital.")
```
